...
function load_level(id){
    ...
    if(id == -2){
        ...
        do{
            ...
            if(tile_type === 1){
            ...
            }else if(tile_type === 0 || tile_type === 3){
                if(Math.random() < .25){
                    world_dynamic.push(
                ...
                if(Math.random() < .6){
                    if(Math.random() < .5){
                        ...
                        world_dynamic.push([tile_middle_x + (Math.random() * 125) + 25, 100 - random_number(275), 25, 25, 3, 0, 0, 0, -175, 100, 2])
                    }
                }
                world_dynamic.push(
            ...
            world_dynamic.push([tile_middle_x + (tile_count > total_tiles / 2 ? 0 : 200), -190, 200, 15, 1, 0, 0, 0, 0, 0, 0])
        }while(tile_count--);
        ...
        if(side){
            if(endtile_left === 1){
                key_y = -90
            }else if(endtile_left === 6 || endtile_left === 8){
                key_y = -50
            ...
            if(endtile_left === 0 || endtile_left === 3){
                key_x += 25
            }else if(endtile_left === 2 || endtile_left === 4){
                key_x += 75
            ...
            if(endtile_right === 1){
                key_y = -90
            }else if(endtile_right === 6 || endtile_right === 8){
                key_y = -50
            ...
            if(endtile_right === 0 || endtile_right === 3){
                key_x -= 25
            }else if(endtile_right === 2 || endtile_right === 4){
                key_x -= 75
