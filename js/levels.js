...
function load_level(id){
    ...
    // Premade levels.
        ...
        world_background = level['world-background'];
        world_dynamic = level['world-dynamic'];
        world_static = level['world-static'];
        world_text = level['world-text'];
    }
}
